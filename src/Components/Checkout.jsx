...
function Checkout({ topMargin }) {
  ...
  return (
    ...
    >
      <h1 className=" lg:text-2xl lg:mb-2 text-black">
        PharmaTrade {`>`} Checkout
      </h1>
      <div className="bg-white rounded-lg p-8  md:w-full lg:h-full">
        <h1 className="lg:text-2xl font-semibold text-black lg:mb-6 ">
          Checkout
        </h1>
        ...
        <div className="lg:flex lg:flex-row gap-10">
          ...
          <div>
            <form>
              <h1 className="lg:mb-8 lg:text-xl font-semibold text-black">
                Billing Details
              </h1>
              <div className=" md:flex  md:flex-row  md:gap-2 lg:gap-10">
                <div className=" md:flex gap-2 lg:mb-2 md:flex-col">
                  <label>First name</label>
                  <input
                    required
                    type="text"
                    className="border-check border-2 rounded-md  p-1 md:w-96 md:h-fit"
              ...
              <div className=" md:flex lg:mb-2 gap-2 md:flex-col">
                ...
                <input
                  ...
                  type="text"
                  placeholder=""
                  className="border-check border-2 rounded-md  p-1 md:w-full md:h-fit"
                />
              </div>
              <div className=" md:flex lg:mb-2 gap-2 md:flex-col">
